...
class CheckpointManager:
    ...
    def __init__(
        ...
        self.selected_list = [1000, 3000, 5000, 10000, 15000, 20000, 30000, 50000, 100000, 200000, 300000, 500000]
    ...
    def load(self, path: str | Path, is_finetuning=False) -> int:
        """
            ...
            if key in self.checkpointables:
                ...
                if isinstance(self.checkpointables[key], DistributedDataParallel):
                    try: 
                        ...
                        # self.checkpointables[key] = checkpoint[key]
                else:
                    try:
                        # self.checkpointables[key].load_state_dict(checkpoint[key], strict=False)
