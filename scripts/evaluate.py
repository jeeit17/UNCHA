...
"""
Evaluate a trained model using implementations from `uncha.evaluation` module.
"""
...
_AA("--checkpoint-path", help="Path to checkpoint of a trained UNCHA/HyCoCLIP/MERU/CLIP model.")
